...
const ChatBotTest = () => {
  const steps = [
    ...
    {
      id: '5',
      message: '1. 마우스로 이동하고 싶은 구를 클릭하면 해당 구의 관광, 맛집, 교통 정보를 알 수 있어 2. 오른쪽 하단에 라디오 버튼을 클릭하면 해당 구의 지역 위치에 따라 색깔 별로 분류해놨고 간략하게 해당 지역의 설명을 해놨으니 읽어봐! (표지판의 색깔을 통해서 구분할 수 있어)',
      trigger: '2',
    },
    {
      id: '4',
